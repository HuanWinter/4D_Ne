...
p.add_argument("-RO_data", type=str,
               default="'data/Delay/330w_0_minutes_geom_height0.mat'",
               help="RO dataset")
p.add_argument("-Solar_act", type=str, default="low",
               help="Solar activity")
p.add_argument("-Iono_data", type=str,
               default="../../Omni_data/HRO_height0.mat",
               help="Ionosonde dataset")
p.add_argument("-coastlines", type=str,
               default="'../../matlab_fun/coastline.mat'",
               help="Locations of the coastlines")

args = p.parse_args()

############################ load the data ############
i = 0
solar_act = args.Solar_act # 'high' #'low'
#data = sio.loadmat('data/Delay/all_'+str(i)+'.mat')
data_RO = sio.loadmat(args.RO_data)
...
data = sio.loadmat(args.Iono_data)
